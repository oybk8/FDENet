...
def basic_blocks(dim,
    ...
    #new
    # if index <2:
    #     blocks.append(EdgeDilationSharpening(dim))  # 64 128
    return blocks
...
class TransXNet(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        if self.init_cfg is None and pretrained is None:
            ...
            #new
            # if state_dict['patch_embed.proj.conv.weight'].shape[1] !=self.in_chans:
            #     del state_dict['patch_embed.proj.conv.weight']
...
def transxnet_s(pretrained=False, init_cfg=None, **kwargs):
    if pretrained: # 'https://github.com/LMMMEng/TransXNet/releases/download/v1.0/transx-s.pth.tar'
        init_cfg=dict(type='Pretrained', 
